...
public class VoiceLineView extends View {
    ...
    private void initAtts(Context context, AttributeSet attrs) {
        ...
        mode = typedArray.getInt(R.styleable.voiceView_viewMode, 1);
        ...
        if (mode == RECT) {
            rectWidth = typedArray.getDimension(R.styleable.voiceView_rectWidth, 10);
            rectSpace = typedArray.getDimension(R.styleable.voiceView_rectSpace, 50);
            rectInitHeight = typedArray.getDimension(R.styleable.voiceView_rectInitHeight, 40);
        } else {
            ...
            lineSpeed = typedArray.getInt(R.styleable.voiceView_lineSpeed, 180);
