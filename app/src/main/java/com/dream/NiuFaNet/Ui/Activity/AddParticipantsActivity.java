...
public class AddParticipantsActivity extends CommonActivity {
    ...
    public void initView() {
        ...
        list.add("1");
        list.add("1");
        participant_lv.setAdapter(new ParticipantsAdapter(getApplicationContext(),list,R.layout.view_addparticipants));
