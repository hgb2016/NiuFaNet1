...
public class FunctionViewAdapter1 extends BaseAdapter {
    //上下文
    ...
    public FunctionViewAdapter1(Context context, String[] titles) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null) {
            convertView=inflater.inflate(R.layout.view_img, null);
        }
